...
## Experience
> 실제 인턴 경험이 있는 경우에만 작성해 주세요. 실제 담당했던 업무를 [STAR](https://newsroom.daewoong.co.kr/archives/2493)기법을 이용해서 기술해 주시기 바랍니다.

 **마케팅&데이터 분석(인턴)** (2021.09.07 ~ 2021.12.06)  
- 쇼핑몰 관리, 바이럴 마케팅, 제품 관련 컨텐츠 제작
- 쇼핑몰 트래픽 데이터 분석 대시보드를 작성하여 수작업으로 진행하던 보고서 작성에 들어가는 시간을 1/5로 단축시킴
- 팀 함류 후 쇼핑몰의 매출 증대가 20% 발생함
...
## Projects
> 수업이나 스터디에서 진행했던 프로젝트들을 적습니다. Experience 섹션과 마찬가지로 프로젝트에서 실제 담당했던 역할을 [STAR](https://newsroom.daewoong.co.kr/archives/2493)기법을 이용해서 기술해 주시기 바랍니다.
